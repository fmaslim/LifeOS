...
export type RouteName = 'dashboard' | 'today' | 'activity' | 'calendar' | 'notes' | 'tasks' | 'goals' | 'projects' | 'habits' | 'learning' | 'contacts' | 'automations' | 'content' | 'jarvis' | 'dociq' | 'finances' | 'home' | 'health' | 'settings'
