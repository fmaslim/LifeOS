...
export type RouteName = 'dashboard' | 'daily-brief' | 'today' | 'activity' | 'calendar' | 'notes' | 'tasks' | 'goals' | 'projects' | 'habits' | 'learning' | 'contacts' | 'reading' | 'documents' | 'budget' | 'property' | 'content-pipeline' | 'automation-builder' | 'automations' | 'schedules' | 'automation-history' | 'content' | 'jarvis' | 'dociq' | 'finances' | 'home' | 'health' | 'settings'
