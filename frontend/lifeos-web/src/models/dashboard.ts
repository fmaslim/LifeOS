export type DashboardIcon = 'grid' | 'bolt' | 'play' | 'sparkles' | 'file' | 'wallet' | 'home' | 'heart' | 'settings' | 'arrow' | 'more' | 'check' | 'clock' | 'search' | 'files' | 'scan' | 'alert' | 'review' | 'folder' | 'upload' | 'users' | 'send' | 'mail' | 'chart' | 'refresh' | 'chevron' | 'target'
