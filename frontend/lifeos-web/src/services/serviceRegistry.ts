...
export function createServiceRegistry() { return { activity: new MockActivityService(), automations: new MockAutomationsService(), calendar: new MockCalendarService(), contacts: new MockContactService(), content: new MockContentService(), dashboard: new MockDashboardService(), documents: new MockDocumentService(), docIQ: new MockDocIQService(), finances: new MockFinancesService(), goals: new MockGoalService(), habits: new MockHabitService(), health: new MockHealthService(), home: new MockHomeService(), jarvis: new MockJarvisService(), learning: new MockLearningService(), notes: new MockNoteService(), notifications: new MockNotificationService(), projects: new MockProjectService(), reading: new MockReadingService(), search: new MockSearchService(), settings: new MockSettingsService(), shell: new MockShellService(), tasks: new MockTaskService(), today: new MockTodayService() } }
