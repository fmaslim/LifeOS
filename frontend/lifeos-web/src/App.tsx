...
function App() {
  ...
  if (route === 'settings') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<SettingsPage data={settingsData} icon={({ name, size }) => <Icon name={name} size={size ?? 18} />} /></main></div>
