...
const ApprovalInboxPage = lazy(() => import('./components/ApprovalInboxPage').then(module => ({ default: module.ApprovalInboxPage })))
...
const NextActionsPage = lazy(() => import('./components/NextActionsPage').then(module => ({ default: module.NextActionsPage })))
...
const PlanningPage = lazy(() => import('./components/PlanningPage').then(module => ({ default: module.PlanningPage })))
const ProductionHealthPage = lazy(() => import('./components/ProductionHealthPage').then(module => ({ default: module.ProductionHealthPage })))
...
function AppRoutes() {
  ...
  if (route === 'approvals') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<ApprovalInboxPage service={services.approvals} /></main></div>
  ...
  if (route === 'finances') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<FinancesPage data={financesData} icon={({ name, size }) => <Icon name={name} size={size ?? 18} />} /></main></div>
  if (route === 'home') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<HomePage data={homeData} icon={({ name, size }) => <Icon name={name} size={size ?? 18} />} /></main></div>
  if (route === 'health') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<HealthPage data={healthData} icon={({ name, size }) => <Icon name={name} size={size ?? 18} />} /></main></div>
  if (route === 'today') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<TodayPage data={todayData} icon={({ name, size }) => <Icon name={name} size={size ?? 18} />} /></main></div>
  if (route === 'calendar') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<CalendarPage data={calendarData} /></main></div>
  ...
  if (route === 'planning') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<PlanningPage service={services.planning} approvals={services.approvals} goals={goalData} projects={projectData} /></main></div>
  if (route === 'next-actions') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<NextActionsPage service={services.nextActions} approvals={services.approvals} /></main></div>
  ...
  if (route === 'documents') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<DocumentsPage data={documentData} /></main></div>
  if (route === 'budget') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<BudgetPage data={budgetData} /></main></div>
  if (route === 'property') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<PropertyPage data={propertyData} /></main></div>
  if (route === 'content-pipeline') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<ContentPipelinePage data={contentPipelineData} /></main></div>
  if (route === 'automation-builder') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<AutomationBuilderPage data={workflowDraftData} /></main></div>
  if (route === 'notes') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<NotesPage data={noteData} /></main></div>
  if (route === 'tasks') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<TasksPage tasks={taskData.tasks} /></main></div>
  if (route === 'goals') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<GoalsPage data={goalData} /></main></div>
  if (route === 'settings') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<SettingsPage data={settingsData} providers={integrationProviders} /></main></div>
  if (route === 'content') return <div className="app-shell"><Sidebar activeRoute={route} /><main id="main-content" tabIndex={-1} className="main-content">{topbar}<ContentPage contentService={contentService} /></main></div>
