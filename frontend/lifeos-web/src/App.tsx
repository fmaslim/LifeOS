...
import { MockContentGenerationService } from './services/MockContentGenerationService'
...
const contentGenerationService = new MockContentGenerationService()
const contentGeneration = contentGenerationService.getLatestGeneration()
...
function App() {
  ...
  if (route === 'content') return <div className="app-shell"><Sidebar activeRoute={route} /><main className="main-content">{topbar}<ContentPage result={contentGeneration} /></main></div>
