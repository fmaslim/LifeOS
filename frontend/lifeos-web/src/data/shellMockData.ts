...
export const shellMockData: ShellData = {
  ...
  navigation: [
    { label: 'Dashboard', route: 'dashboard', icon: 'grid' }, { label: 'Today', route: 'today', icon: 'check' }, { label: 'Automations', route: 'automations', icon: 'bolt' }, { label: 'Content', route: 'content', icon: 'play' }, { label: 'Jarvis', route: 'jarvis', icon: 'sparkles' }, { label: 'DocIQ', route: 'dociq', icon: 'file' }, { label: 'Finances', route: 'finances', icon: 'wallet' }, { label: 'Home', route: 'home', icon: 'home' }, { label: 'Health', route: 'health', icon: 'heart' }, { label: 'Settings', route: 'settings', icon: 'settings' },
  ],
  placeholderPages: [
