...
const backup: LifeOSBackup = { schema: 'lifeos-local-backup', version: 1, exportedAt: '2026-09-14T00:00:00.000Z', data: { tasks: [{ id: 't1' }], goals: [], notes: [{ id: 'n1' }], calendar: [], habits: [], projects: [], routines: [], goalProjectLinks: [], projectDependencies: [] }, preferences: { dashboardWidgets: [{ id: 'summary', visible: true }] } }
